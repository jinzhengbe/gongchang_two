...
CREATE TABLE IF NOT EXISTS users (
    ...
    user_type ENUM('admin', 'designer', 'factory', 'supplier') NOT NULL,
...
INSERT INTO users (id, username, password, email, role, user_type) 
SELECT UUID(), 'admin', '$2a$10$xVB1H7qIJT.z8Xw9H3zOyeQZr0Kq8X9q9Y9X9q9Y9X9q9Y9X9q', 'admin@sewingmast.com', 'admin', 'admin'
